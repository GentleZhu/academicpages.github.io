...
My research interest is weakly-supervised graph representation learning on heterogenous information networks such as citation networks and knowledge graphs. Recently, I'm working on large-scale label-efficient graph mining algorithms, especially graph neural networks. Most of the work on network structured data can scale up to millions of nodes. 
